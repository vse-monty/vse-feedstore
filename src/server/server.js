...
io.on('connection', function(socket){
    ...
    socket.on('illustrator.close', function () {
        console.log('\nSERVER: telling illustrator to close')
        socket.broadcast.emit('close.illy')
    });

    socket.on('illustrator.reboot', function () {
        console.log('\nSERVER: telling app to reboot illustrator')
        socket.broadcast.emit('illustrator.reboot')
    });
